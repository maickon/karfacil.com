...
$veiculo_usu->extras_select = "WHERE id=".$_GET['id'];
$veiculo_usu->seleciona_tudo($veiculo_usu);
$veiculo_usu_resp = $veiculo_usu->retorna_dados();

$dono = new usuarioDeVendaCarro();
$dono->extras_select = "WHERE id=".$_GET['d_id'];
$dono->seleciona_tudo($dono);
$dono_resp = $dono->retorna_dados();

if($veiculo_usu->linhas_afetadas == 0):
?>
...
<div class="slide"> 
	<div id="destaques" align="center">
		<a class="faixa" href="#" title=""></a>
	    	<ul>
	        	<li>
	            	<a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><img src="<?php echo IMGEXCLUSIVOSPATH.$veiculo_usu_resp->img_1.'/'.$veiculo_usu_resp->img_1 ?>" alt="<?php echo $veiculo_usu_resp->nome?> destaque" /></a>
	                <div class="fundo"></div>
	                <p><a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><?php echo $veiculo_usu_resp->nome?></a></p>            
	            </li>
	            
	            <li>
	            	<a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><img src="<?php echo IMGEXCLUSIVOSPATH.$veiculo_usu_resp->img_1.'/'.$veiculo_usu_resp->img_2 ?>" alt="<?php echo $veiculo_usu_resp->nome?> destaque" /></a>
	                <div class="fundo"></div>
	                <p><a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><?php echo $veiculo_usu_resp->nome?></a></p>            
	            </li>
	            
	            <li>
	            	<a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><img src="<?php echo IMGEXCLUSIVOSPATH.$veiculo_usu_resp->img_1.'/'.$veiculo_usu_resp->img_3 ?>" alt="<?php echo $veiculo_usu_resp->nome?> destaque" /></a>
	                <div class="fundo"></div>
	                <p><a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><?php echo $veiculo_usu_resp->nome?></a></p>            
	            </li>
	            
	            <li>
	            	<a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><img src="<?php echo IMGEXCLUSIVOSPATH.$veiculo_usu_resp->img_1.'/'.$veiculo_usu_resp->img_4 ?>" alt="<?php echo $veiculo_usu_resp->nome?> destaque" /></a>
	                <div class="fundo"></div>
	                <p><a href="#" title="<?php echo $veiculo_usu_resp->nome?> destaque"><?php echo $veiculo_usu_resp->nome?></a></p>            
	            </li>
...
<?php exibirVeiculoUsu($veiculo_usu_resp)?>
<hr />
