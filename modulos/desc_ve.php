...
<div align="center">
	<p title="Aqui você encontrará todos os tipos de veículos."><a href="<?php echo '?p=listar_veiculos&categoria=carros'?>">Visualizar outros veículos.</a> 
	ou
	<a title="Aqui você encontrará apenas a lista de veículos que pertencem a pessoas físicas." href="<?php echo '?p=listar_exclusivos'?>">Visualizar veículos exclusivos.</a>	
	</p>
</div> 
